...
function fShader() {
    ...
    'uniform sampler2D image0;' + 
     ...
     'Intersection interSect(vec4 origin, vec4 direction, float coeff) {' + 
         ...
         'vec4 position = vec4(origin.xyz + distance * direction.xyz, 1.0);' + 
     ...
     'vec4 getObjColor(Intersection i) {' + 
        ...
        '} else {' + 
            ...
            'specular = 0.0;' + 
        '}' + 
        'vec4 mycaustics = caustics(i.position);' + 
     ...
     '}' + 
      'void main(void) {' + 
         'gl_FragColor = calColor(gl_FragCoord);' + 
     '}';
